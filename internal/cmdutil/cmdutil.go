...
func NewDatabasePool(ctx context.Context) (repository.Executor, error) {
...
func NewDatabasePoolWithRetry(ctx context.Context, retries int) (repository.Executor, error) {

	var db repository.Executor
	var err error
