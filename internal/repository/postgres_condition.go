...
func (r *postgresConditionRepository) GetByID(ctx context.Context, conditionID int64) (*domain.Condition, error) {
...
func (r *postgresConditionRepository) ListByRegionID(ctx context.Context, regionID string) ([]*domain.Condition, error) {
...
func (r *postgresConditionRepository) Delete(ctx context.Context, conditionID int64) error {
