...
func (r *postgresRuleRepository) GetByID(ctx context.Context, ruleID int64) (*domain.Rule, error) {
...
func (r *postgresRuleRepository) ListByRegionID(ctx context.Context, regionID string) ([]*domain.Rule, error) {
