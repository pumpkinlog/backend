...
func (r *postgresDeviceRepository) GetByID(ctx context.Context, userID, deviceID string) (*domain.Device, error) {
...
func (r *postgresDeviceRepository) List(ctx context.Context, userID string) ([]*domain.Device, error) {
...
func (r *postgresDeviceRepository) Delete(ctx context.Context, userID, deviceID string) error {
