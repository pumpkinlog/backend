...
func (r *postgresPresenceRepository) GetByID(ctx context.Context, userID int64, regionID string, date time.Time) (*domain.Presence, error) {
...
func (r *postgresPresenceRepository) ListByRegionBounds(ctx context.Context, userID int64, bounds map[string]domain.TimeWindow) ([]*domain.Presence, error) {
...
func (r *postgresPresenceRepository) ListByRegionPeriod(ctx context.Context, userID int64, regionID string, start, end time.Time) ([]*domain.Presence, error) {
...
func (r *postgresPresenceRepository) CreateRange(ctx context.Context, userID int64, regionID string, deviceID *int64, start, end time.Time) error {
...
func (r *postgresPresenceRepository) Delete(ctx context.Context, userID int64, regionID string, date time.Time) error {
...
func (r *postgresPresenceRepository) DeleteRange(ctx context.Context, userID int64, regionID string, start, end time.Time) error {
