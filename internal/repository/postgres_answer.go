...
func (r *postgresAnswerRepository) GetByID(ctx context.Context, userID, conditionID int64) (*domain.Answer, error) {
...
func (r *postgresAnswerRepository) ListByRegionID(ctx context.Context, userID int64, regionID string) ([]*domain.Answer, error) {
...
func (r *postgresAnswerRepository) Delete(ctx context.Context, userID, conditionID int64) error {
