...
type PresenceRepo struct {
	...
	ListFunc               func(ctx context.Context, userID string, filter *domain.PresenceFilter) ([]*domain.Presence, error)
...
func (m PresenceRepo) List(ctx context.Context, userID string, filter *domain.PresenceFilter) ([]*domain.Presence, error) {
...
type PresenceService struct {
	CreateFunc func(ctx context.Context, userID, regionID string, deviceID *string, start, end time.Time) error
	DeleteFunc func(ctx context.Context, userID, regionID string, start, end time.Time) error
}

func (m PresenceService) Create(ctx context.Context, userID, regionID string, deviceID *string, start, end time.Time) error {
	return m.CreateFunc(ctx, userID, regionID, deviceID, start, end)
}

func (m PresenceService) Delete(ctx context.Context, userID, regionID string, start, end time.Time) error {
