...
type UserService struct {
	CreateFunc func(ctx context.Context, favoriteRegions, wantResidency []string) error
	UpdateFunc func(ctx context.Context, userID int64, favoriteRegions, wantResidency []string) error
}

func (m UserService) Create(ctx context.Context, favoriteRegions, wantResidency []string) error {
	return m.CreateFunc(ctx, favoriteRegions, wantResidency)
}

func (m UserService) Update(ctx context.Context, userID int64, favorioteRegions, wantResidency []string) error {
