...
type UserService interface {
	Create(ctx context.Context, favoriteRegions, wantResidency []string) error
	Update(ctx context.Context, userID int64, favoriteRegions, wantResidency []string) error
}
