...
func TestCreateUser(t *testing.T) {
	...
	tests := []struct {
		name         string
		mockCreate   func(ctx context.Context, favoriteRegions, wantResidency []string) error
		request      string
		expectedCode int
	}{
		{
...
func TestUpdateUser(t *testing.T) {
	...
	tests := []struct {
		...
		authenticated bool
		request       string
		mockUpdate    func(ctx context.Context, userID int64, favoriteRegions, wantResidency []string) error
		expectedCode  int
	}{
		{
			name:          "updated user",
